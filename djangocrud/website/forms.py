...
class AddProductForm(forms.ModelForm):
  ...
  price = forms.FloatField(required=True, widget=forms.widgets.NumberInput(attrs={"placeholder":"Price","class": "form-control"}), label="")
  image = forms.ImageField(required=True, widget=forms.widgets.FileInput(attrs={"class": "form-control"}), label="")
